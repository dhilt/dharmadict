...
`
  ...
  url: 'ZAG',
  title: 'Загуменнов Борис Иванович',
  text: `
<p>
Закончил философский факультет и аспирантуру ЛГУ. Изучал немецкий,
английский, основы санскрита и тибетского. Переводил и редактировал
индуистскую и буддийскую классику: Йога-сутры, &quot;Веданта-сару» Шри
Садананды, Гимны Шанкары, Нагарджуну, Гамбопу и др. Позже, имея опыт
переводов восточных текстов, публиковал статьи о переводоведении. Имеет
собственный сайт - <a href="http://zagumyonnov.16mb.com/">zagumyonnov.16mb.com</a>,
где выложены его переводы и статьи.
</p>
`
}];
