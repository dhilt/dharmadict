...
<ul>
  <li><Link to='/user?name=don'>А.М. Донца</Link> (по изданию "Введение в Мадхьямику" Чандракирти)</li>
  <li><Link to='/user?name=zag'>Б.И. Загуменного</Link> (по глоссарию с сайта переводчика)</li>
  <li><Link to='/user?name=mk'>М.Н. Кожевниковой</Link> (по глоссарию предоставленному переводчиком в электронном виде)</li>
  <li><Link to='/user?name=akt'>А. Кугявичуса и А.А.Терентьева</Link> (по предоставленной переводчиками, электронной версии индексов к "Большому руководству к этапам Пути Пробуждения" Чже Цонкапы)</li>
  <li><Link to='/user?name=hop'>J. Hopkins</Link></li>
  <li><Link to='/user?name=brz'>A. Berzin</Link></li>
</ul>
