...
import {changePageData, resetPage, getPageAdminAsync, updatePageAsync} from '../../actions/admin/changePage'
...
class EditPage extends Component {
  ...
  render () {
    const { sourcePending, pending } = this.props.pageInfo
      ...
      <div>
        <form className="col-md-6">
          ...
          <div className="form-group">
            ...
            <Link data-test-id="button-cancel" to={`/pages/${this.props.params.pageUrl}`}>
